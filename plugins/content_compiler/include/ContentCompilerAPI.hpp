...
struct ContentCompiler_API {
    // Blocking load
    struct MeshData* (*LoadMeshFromFile)(const char* fname, bool interleaved);
    ...
    void (*AsyncLoadMeshFromFile)(const char* fname, bool interleaved, void* requester, mesh_loaded_signal_t signal);
